...
const ChartInfo = ({ data }) => {
    ...
    const total_expenses = sum(data["expenseData"])
    const total_income = sum(data["incomeData"])
            ...
            <Box sx={{ display: "flex", justifyContent: "center", alignItems: "end", gap: 3, position: "absolute", right: 40, top: 120 }}>
                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "end", gap: 1 }}>
                    ...
                    <Box>
                        ...
                        <Typography fontSize={"20px"} fontWeight={600}>{total_income}</Typography>
                    </Box>
                </Box>
                ...
                <Box sx={{ display: "flex", justifyContent: "center", alignItems: "end", gap: 1 }}>
                    ...
                    <Box>
                        ...
                        <Typography fontSize={"20px"} fontWeight={600}>{total_expenses}</Typography>
                    </Box>
                </Box>
            </Box>
